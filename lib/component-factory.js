...
function ComponentFactory(config, builderOpts, branch, logger) {
  ...
  this.fileHandler = new RepositoryFileHandler(builderOpts.sitePath);
  this.configHandler = new ConfigHandler(
    builderOpts, branch, this.fileHandler, logger);
  this.jekyllHelper = new JekyllCommandHelper(
    config, builderOpts, this.commandRunner);
